...
export default function VerticalTabs() {
    ...
    <>
      <div className="md:flex">
        <ul className="flex-column space-y mb-4 space-y-4 text-sm font-medium text-gray-500 dark:text-gray-400 md:mb-0 md:me-4">
          ...
          <li>
            <a className="inline-flex w-full cursor-not-allowed items-center rounded-lg bg-gray-50 px-4 py-3 text-gray-400 dark:bg-gray-800 dark:text-gray-500">
              <svg
        ...
        <div className="text-medium w-full rounded-lg bg-gray-50 p-6 text-gray-500 dark:bg-gray-800 dark:text-gray-400">
          ...
          <p>
            The tab JavaScript swaps cladsses to control the content visibility
            and styling.
          </p>
        </div>
      </div>
  ...
  //           return <Tab key={index} label={section.slug} {...a11yProps(index)} />;
  //         })}
  //       </Tabs>
